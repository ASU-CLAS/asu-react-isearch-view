...
render(){
 ...
 let alphabetList = alphabet.map( letter =>
        {
            return(
                <a key={letter} href="" className={this.props.selectedLetter === letter ? 'active-letter' : null} onClick={this.props.onClick} id={letter}><span className="" id={letter}>{letter}</span></a>
            )
        }
    )
